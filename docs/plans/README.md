...
|---|---|---|---|---|
| [0001](0001-pedidos-diarios/PLAN.md) | Pedidos diarios (toma de pedido) | 📝 Borrador | `customers`, `catalog`, `orders`, `promotions` | 2026-07-22 |
...
| [0004](0004-sincronizacion-offline/PLAN.md) | Offline-first y sincronización (fundacional — precede a 0001) | 📝 Borrador | `sync`, APP Flutter | 2026-07-22 |
...
| [0006](0006-ui-app-fase1/PLAN.md) | PRD de UI: módulos y pantallas de la app (fase 1) | 📝 Borrador | APP Flutter, `design_system` | 2026-07-27 |
